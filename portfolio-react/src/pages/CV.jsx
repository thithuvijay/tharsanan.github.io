...
export default function CV() {
  return (
    <main className="relative pb-20 bg-transparent min-h-screen overflow-hidden">
      ...
      {/* Download button */}
      <div className="section-container -mt-8 md:-mt-12 mb-8 md:mb-12 relative z-10">
        <motion.div
        ...
        >
          <Magnetic>
            <a href="documents/cv-tharsanan-alternance.pdf?v=2" download className="btn-premium gap-3 text-lg px-10 py-5 group">
          ...
          <div className="space-y-16">
            ...
            <div className="space-y-12">
              ...
              <div className="mt-32 relative perspective-[1200px] flex justify-center md:justify-start">
                <a href={`${import.meta.env.BASE_URL}documents/cv-tharsanan-alternance.pdf?v=2`} target="_blank" rel="noreferrer" className="block">
                  <motion.div
                  ...
                  >
                    ...
                    <div className="relative w-64 md:w-80 rounded-sm overflow-hidden border border-white/10 shadow-2xl transition-all duration-700 group-hover:rotate-x-0 group-hover:rotate-z-0 group-hover:scale-105 group-hover:-translate-y-10">
                      <img 
                        src={`${import.meta.env.BASE_URL}images/cv/cv-tharsanan-alternance.png?v=2`} 
